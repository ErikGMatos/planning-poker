...
export const VotingRoom: React.FC = () => {
  ...
  const setReveal = useMutation(({ storage }, value: boolean) => {
  ...
  const customVote =
    presence.vote && !baseOptions.includes(presence.vote)
      ? presence.vote
      : null;
  ...
  const votedCount = allUsers.filter(
    user => user.presence.vote !== null
  ).length;
                  ...
                  <div key={user.id} className='participant-item'>
                    ...
                    <div className='participant-status'>
                      {reveal ? (
                        ...
                        <span
                          className={`badge ${user.presence.vote !== null ? 'badge-green' : 'badge-yellow'}`}
                        >
                          {user.presence.vote !== null ? '✓' : '⏳'}
                        </span>
                      )}
