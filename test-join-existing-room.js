...
async function testJoinExistingRoom() {
  ...
  try {
    ...
    try {
      ...
      console.log('📤 Enviando comando create:', JSON.stringify(createRoomCommand, null, 2));
      
      const createResult = await connection.invoke(SocketMethods.CreateRoom, createRoomCommand);
      console.log('✅ Sala criada com sucesso!');
      console.log('📥 Resposta do servidor:', JSON.stringify(createResult, null, 2));
      ...
      if (createResult && createResult.id) {
        ...
        console.log('📤 Enviando comando join na nova sala:', JSON.stringify(newJoinCommand, null, 2));
        
        const newJoinResult = await connection.invoke(SocketMethods.JoinRoomAsync, newJoinCommand);
        console.log('✅ Join na nova sala realizado com sucesso!');
        console.log('📥 Resposta do servidor:', JSON.stringify(newJoinResult, null, 2));
      }
    }
