...
async function testRoomUsers() {
  ...
  try {
    ...
    console.log(
      '📋 Lista de usuários:',
      JSON.stringify(createResult.users, null, 2)
    );
    ...
    if (joinResult && joinResult.users) {
      ...
      console.log(
        '📋 Lista de usuários:',
        JSON.stringify(joinResult.users, null, 2)
      );
    } else {
    ...
    const joinResult2 = await connection.invoke(
      SocketMethods.JoinRoomAsync,
      joinCommand2
    );
    ...
    console.log(
      '📋 Lista de usuários:',
      JSON.stringify(joinResult2.users, null, 2)
    );
